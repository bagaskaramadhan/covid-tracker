    ...
    return (
      ...
      <div className="row text-center" style={{ marginBottom: '70px' }}>
        <div className="col-lg-12">
          <Image src={CovidImage} alt="CovidImage" width='350px' fluid />
      ...
      <div className="fixed-bottom text-center text-white-50" style={{ padding: '13px', backgroundColor: '#7F90FC' }}>Copyright 2020 | Bagaskara Ramadhan</div>
    </div>
    )
}
